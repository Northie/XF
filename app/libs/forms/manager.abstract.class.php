...
abstract class manager extends \libs\data\formService {
	...
	public function CheckIn() {
		...
		for($i=0;$i<count($this->definition);$i++) {
			...
			$_SESSION['form_data'][$this->form_name][$i]['store_value'] = $this->filterIn($this->definition[$i]['input_type'], $_POST[$this->definition[$i]['name']]);
