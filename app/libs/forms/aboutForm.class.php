...
class aboutForm extends manager {
	...
	public function getFormDefinition() {
		...
		$this->form_name = 'About';
		$this->action = \core\System_Settings::Load()->getSettings('ADMIN_BASE').'/about';
		...
		$this->submit_label = 'Save About Page';
