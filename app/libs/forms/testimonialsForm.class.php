...
class testimonialsForm extends manager {
	...
	public function getFormDefinition() {
		...
		$this->form_name = 'Testimonials';
		$this->action = \core\System_Settings::Load()->getSettings('ADMIN_BASE').'/testimonials';
		...
		$form[] = [
			...
			//,"validate"=>""
			,"data_type"=>"text"
			,"notes"=>"Enter your customer testimonials here"
		];
		$form[] = [
			 "label"=>"Side Content"
			,"name"=>"side_content"
		...
		$this->submit_label = 'Save Testimonials Page';
