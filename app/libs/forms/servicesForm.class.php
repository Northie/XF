...
class servicesForm extends manager {
	...
	public function getFormDefinition() {
		...
		$this->action = \core\System_Settings::Load()->getSettings('ADMIN_BASE').'/services';
		...
		$this->submit_label = 'Save Services and Amenities Page';
