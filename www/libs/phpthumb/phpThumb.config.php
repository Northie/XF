...
$PHPTHUMB_CONFIG['error_silent_die_on_error']   = (true ? true : false);    // simply die with no output of any kind on fatal errors (not recommended)
...
$PHPTHUMB_CONFIG['disable_debug']            = (true ? true : false);   // prevent phpThumb from displaying any information about your system. If true, phpThumbDebug and error messages will be disabled
